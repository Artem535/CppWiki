...
**Связанные документы:** xref:01-prd-template.adoc[01 PRD], xref:02-system-design-doc-template.adoc[02 System Design], xref:07-runbook-template.adoc[07 Runbook], xref:09-prompt-template.adoc[09 Prompt Template]
