////
tags: template, system-design, architecture, work, ml, llm
status: draft
...
**Owner:** [Архитектор] +
**Team Lead:** [Имя] +
**Related Docs:** xref:ml-llm-delivery-pipeline/01-prd-template.adoc[01 PRD], xref:ml-llm-delivery-pipeline/03-adr-template.adoc[03 ADR], xref:ml-llm-delivery-pipeline/04-service-spec-template.adoc[04 Service Spec], xref:ml-llm-delivery-pipeline/07-runbook-template.adoc[07 Runbook], xref:ml-llm-delivery-pipeline/09-prompt-template.adoc[09 Prompt Template]
...
* До: `- **[Сущность]** можно использовать в этом сценарии.` +
  После: `[сущность] можно использовать в этом сценарии`
* До: `[Сущность](https://example.com) и [другая сущность]` +
  После: `[сущность] и [другая сущность]`
