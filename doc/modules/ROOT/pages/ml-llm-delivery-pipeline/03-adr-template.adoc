////
tags: template, adr, architecture, work
status: draft
...
**Related Docs:** xref:ml-llm-delivery-pipeline/02-system-design-doc-template.adoc[02 System Design], xref:ml-llm-delivery-pipeline/04-service-spec-template.adoc[04 Service Spec]
...
. [Step 1 of the chosen architecture]
. [Step 2 of the chosen architecture]
. [Step 3 of the chosen architecture]
