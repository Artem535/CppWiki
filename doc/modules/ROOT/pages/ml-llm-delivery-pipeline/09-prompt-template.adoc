////
tags: prompt, llm, template, delivery
status: Draft
date: 2026-04-03
////
...
**Related Docs:** xref:ml-llm-delivery-pipeline/04-service-spec-template.adoc[04 Service Spec], xref:ml-llm-delivery-pipeline/05-evaluation-plan-template.adoc[05 Evaluation Plan]
