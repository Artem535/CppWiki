////
tags: template, service-spec, contract, work, ml, llm
status: draft
...
**Related Docs:** xref:ml-llm-delivery-pipeline/01-prd-template.adoc[01 PRD], xref:ml-llm-delivery-pipeline/02-system-design-doc-template.adoc[02 System Design], xref:ml-llm-delivery-pipeline/05-evaluation-plan-template.adoc[05 Evaluation Plan], xref:ml-llm-delivery-pipeline/09-prompt-template.adoc[09 Prompt Template]
