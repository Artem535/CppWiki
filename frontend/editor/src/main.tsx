...
// (NotebookView, #52), "excalidrawCanvas" (ExcalidrawCanvasView, #53) and "projectBoard"
// (ProjectBoardView, #106) now have real renderers; this stays in place only for a future kind
// added without one yet.
function UnsupportedKindPlaceholder({
  kind,
}: {
  kind: Exclude<DocumentKind, "wikiPage" | "jupyterNotebook" | "excalidrawCanvas" | "projectBoard">;
}) {
